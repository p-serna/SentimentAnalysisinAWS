...
## About
This repository is for deploying of a neural network to classify movie reviews. The architecture of the NN is a LSTM module with 200 hidden units and 32 dimensional embeddings followed by a fully-connected layer and a sigmoid.
